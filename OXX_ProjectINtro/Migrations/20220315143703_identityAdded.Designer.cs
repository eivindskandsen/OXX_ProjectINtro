...
namespace OXX_ProjectINtro.Migrations
{
    ...
    [Migration("20220315143703_identityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OXX_ProjectINtro.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("OXX_ProjectINtro.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("OXX_ProjectINtro.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("OXX_ProjectINtro.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OXX_ProjectINtro.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("OXX_ProjectINtro.Models.OrderDetail", b =>
                {
                    b.HasOne("OXX_ProjectINtro.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OXX_ProjectINtro.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OXX_ProjectINtro.Models.Pie", b =>
                {
                    b.HasOne("OXX_ProjectINtro.Models.Category", "Category")
                        .WithMany("Pies")
